...
It lets the user to stay logged in.
1. What does bcrypt do to help us store passwords in a secure manner.
It encrypts or hashes the passwords so hackers have a harder time decrypting it.
1. What does bcrypt do to slow down attackers?
The hashing of the password makes it harder for attackers, since they need to decrypt it.
